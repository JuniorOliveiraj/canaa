...
export const urlApi ='https://appcanaabackend-production.up.railway.app'//'https://api.juniorbelem.com'// //'http://localhost:8080' // protocol + "//junior-oliveira.epizy.com/public/register"; //
