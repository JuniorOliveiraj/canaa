...
import { BlogPostTags , BlogPostRecent,BlogPostHero} from '../../_dashboard/blog';
...
export default function ProjetosLer() {
  ...
  return (
    <Page
      title={post ? post.title : "Projetos: Post Details | Junior"}
